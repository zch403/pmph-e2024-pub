          ...
          for(int i=0; i<Ry; i++) {
              ...
              for(int j=0; j<Rx; j++) {
                 ...
                 ***************************************/
                  ...
                  css[i][j] +=  
                    Aloc[i*Ty + threadIdx.y][k] *
                    Bloc[k][Tx*j+threadIdx.x];
